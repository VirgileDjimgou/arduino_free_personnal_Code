/*
GSM_GPS_Shield.cpp - Libary for using the GSM-Modul on the GSM/GPRS/GPS-Shield Rev.8 (without GPS)
Included Functions
Version:     1.5.0
Date:        10.04.2013
  ...
  { 
    ...
    {    
      ...
      if((gps_data_buffer[0] == '$') && (gps_data_buffer[1] == 'G') && (gps_data_buffer[2] == 'P') && (gps_data_buffer[3] == 'G') && (gps_data_buffer[4] == 'G')&& (gps_data_buffer[5] == 'A'))
      {
	   ...
	   if((gps_data_buffer[0] == '$') && (gps_data_buffer[1] == 'G') && (gps_data_buffer[2] == 'P') && (gps_data_buffer[3] == 'R') && (gps_data_buffer[4] == 'M')&& (gps_data_buffer[5] == 'C'))
      {
          GPRMC = 1;                                                          
      }
	  ...
	  if((GPRMC == 1) && (i < 80))
      {
        ...
        {      
		  gps_data_gprmc[i]= gps_data_buffer[0];
          i++;
        }
      }
      ...
      if((GPGGA == 1) && (i < 80))
      {
        ...
        {      
          gps_data_gppa[i] = gps_data_buffer[0];                                       // write Buffer into public variable
          i++;
        }
      }
    }      

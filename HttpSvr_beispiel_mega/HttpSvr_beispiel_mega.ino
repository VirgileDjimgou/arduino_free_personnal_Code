...
void writeFreeMem()
{ 
  Serial.println(String("FreeBytes:") + String(memFree()));
}
...
static const uint8_t   HTTPMEGA_MAC_ADDRESS[] = {  0x90, 0xA2, 0xDA, 0x0F, 0xC4, 0x03 };
static const IPAddress HTTPMEGA_STATIC_IP  (192, 168, 1, 102);
static const int       HTTPMEGA_TCP_PORT = 8055;
...
void setup()
{
  ...
  // Initialize LCD
  //configDisplay();
  //Serial.println(HTTPMEGA_APPNAME, HTTPMEGA_APPVER);
  delay(2000);
...
void loop()
{
  ...
  writeFreeMem();  
  Serial.println(String("Conn:") + String(uTotConn));
}

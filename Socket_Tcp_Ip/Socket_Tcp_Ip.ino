...
IPAddress server(192, 168, 1, 100);  // Statische Adresse der Server 

// hier wird versuch , ein statische IP Adress für den Arduino festzusetzen 
IPAddress ip(192, 168, 1, 103); // diese Adress muss geandert werden , je nachdem Ihre Router konfiguration
